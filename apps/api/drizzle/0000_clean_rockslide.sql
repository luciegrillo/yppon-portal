...
--> statement-breakpoint
ALTER TABLE "institutions" ADD CONSTRAINT "institutions_publication_lifecycle_check" CHECK (
	...
	OR ("publication_state" = 'archived' AND "published_at" IS NOT NULL AND "archived_at" IS NOT NULL AND "archived_at" >= "published_at")
);--> statement-breakpoint
ALTER TABLE "iugy_academic_formations" ADD CONSTRAINT "iugy_academic_formations_publication_lifecycle_check" CHECK (
	("publication_state" = 'draft' AND "published_at" IS NULL AND "archived_at" IS NULL)
	OR ("publication_state" = 'published' AND "published_at" IS NOT NULL AND "archived_at" IS NULL)
	OR ("publication_state" = 'archived' AND "published_at" IS NOT NULL AND "archived_at" IS NOT NULL AND "archived_at" >= "published_at")
);--> statement-breakpoint
ALTER TABLE "iugy_calendar_events" ADD CONSTRAINT "iugy_calendar_events_publication_lifecycle_check" CHECK (
	("publication_state" = 'draft' AND "published_at" IS NULL AND "archived_at" IS NULL)
	OR ("publication_state" = 'published' AND "published_at" IS NOT NULL AND "archived_at" IS NULL)
	OR ("publication_state" = 'archived' AND "published_at" IS NOT NULL AND "archived_at" IS NOT NULL AND "archived_at" >= "published_at")
);--> statement-breakpoint
ALTER TABLE "iugy_notices" ADD CONSTRAINT "iugy_notices_publication_lifecycle_check" CHECK (
	("publication_state" = 'draft' AND "published_at" IS NULL AND "archived_at" IS NULL)
	OR ("publication_state" = 'published' AND "published_at" IS NOT NULL AND "archived_at" IS NULL)
	OR ("publication_state" = 'archived' AND "published_at" IS NOT NULL AND "archived_at" IS NOT NULL AND "archived_at" >= "published_at")
);--> statement-breakpoint
ALTER TABLE "iugy_selection_cycles" ADD CONSTRAINT "iugy_selection_cycles_publication_lifecycle_check" CHECK (
	("publication_state" = 'draft' AND "published_at" IS NULL AND "archived_at" IS NULL)
	OR ("publication_state" = 'published' AND "published_at" IS NOT NULL AND "archived_at" IS NULL)
	OR ("publication_state" = 'archived' AND "published_at" IS NOT NULL AND "archived_at" IS NOT NULL AND "archived_at" >= "published_at")
);--> statement-breakpoint
ALTER TABLE "official_documents" ADD CONSTRAINT "official_documents_publication_lifecycle_check" CHECK (
	("publication_state" = 'draft' AND "published_at" IS NULL AND "archived_at" IS NULL)
	OR ("publication_state" = 'published' AND "published_at" IS NOT NULL AND "archived_at" IS NULL)
	OR ("publication_state" = 'archived' AND "published_at" IS NOT NULL AND "archived_at" IS NOT NULL AND "archived_at" >= "published_at")
);--> statement-breakpoint
...
CREATE INDEX "official_documents_public_status_idx" ON "official_documents" USING btree ("publication_state","status");--> statement-breakpoint
...
CREATE TRIGGER "institutions_set_updated_at_trigger"
BEFORE UPDATE ON "institutions"
FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();--> statement-breakpoint
CREATE TRIGGER "iugy_academic_formations_set_updated_at_trigger"
BEFORE UPDATE ON "iugy_academic_formations"
FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();--> statement-breakpoint
CREATE TRIGGER "iugy_calendar_events_set_updated_at_trigger"
BEFORE UPDATE ON "iugy_calendar_events"
FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();--> statement-breakpoint
CREATE TRIGGER "iugy_notices_set_updated_at_trigger"
BEFORE UPDATE ON "iugy_notices"
FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();--> statement-breakpoint
CREATE TRIGGER "iugy_selection_cycles_set_updated_at_trigger"
BEFORE UPDATE ON "iugy_selection_cycles"
FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();--> statement-breakpoint
CREATE TRIGGER "official_documents_set_updated_at_trigger"
